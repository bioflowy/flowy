...
pub fn keywords_for_version(version: &str) -> HashSet<String> {
    ...
    let draft2_keywords = vec![
        "Array", "Boolean", "File", "Float", "Int", "Map", "None", "Pair", "String",
        "as", "call", "command", "else", "false", "if", "import", "input",
        "left", "meta", "object", "output", "parameter_meta", "right",
        "runtime", "scatter", "task", "then", "true", "version", "workflow",
    ];
