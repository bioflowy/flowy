...
impl StdLib {
    ...
    fn register_builtin_functions(&mut self) {
        ...
        self.register(StdoutFunction);
        self.register(StderrFunction);
        self.register(WriteLinesFunction);
        self.register(ReadLinesFunction);
    }
