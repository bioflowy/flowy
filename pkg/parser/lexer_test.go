...
workflow test {
	...
	expectedTypes := []TokenType{
		TokenVersion, TokenFloat,
		TokenWorkflow, TokenIdentifier, TokenLeftBrace,
		TokenInput, TokenLeftBrace,
		TokenStringType, TokenIdentifier,
		TokenIntType, TokenIdentifier, TokenAssign, TokenInt,
		TokenRightBrace,
		TokenCall, TokenIdentifier, TokenLeftBrace, TokenInput, TokenColon,
		TokenIdentifier, TokenAssign, TokenIdentifier, TokenRightBrace,
		TokenOutput, TokenLeftBrace,
		TokenStringType, TokenIdentifier, TokenAssign, TokenIdentifier, TokenDot, TokenIdentifier,
		TokenRightBrace,
		TokenRightBrace,
		TokenEOF,
	}
